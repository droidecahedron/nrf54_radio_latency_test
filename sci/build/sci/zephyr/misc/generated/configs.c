...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_MAX_CONN_EVENT_LEN_DEFAULT, 750);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_CONN_EVENT_EXTEND_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_CENTRAL_ACL_EVENT_SPACING_DEFAULT, 750);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_EXTENDED_FEAT_MAX_REMOTE_PAGE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_FRAME_SPACE_UPDATE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_ENABLE_LOWEST_FRAME_SPACE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HCI_ERR_TO_STR, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_LE_LOCAL_MINIMUM_REQUIRED_FEATURE_PAGE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_LE_MAX_LOCAL_SUPPORTED_FEATURE_PAGE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_LE_EXTENDED_FEAT_SET, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_SUBRATING, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_FRAME_SPACE_UPDATE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_SHORTER_CONNECTION_INTERVALS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SUBRATING, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_EXTENDED_FEAT_SET, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SHORTER_CONNECTION_INTERVALS, 1);
